    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            To respond to inquiries and communicate with you regarding your
            requests.
          </li>
          <li>
            To send updates, newsletters, and other communications related to
            our services, if you have opted-in to receive such information.
          </li>
          <li>
            To improve the functionality, user experience, and content of our
            Website.
          </li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            ...
            requests by public authorities (e.g., court orders or government
            agencies).
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 mb-4">
          ...
          <li>
            <strong>Right to Object to Processing:</strong> You can object to us
            processing your data for direct marketing purposes.
          </li>
          <li>
            <strong>Right to Data Portability:</strong> You have the right to
            request that we transfer your data to another organization, where
            applicable.
          </li>
        </ul>
        <p>
        ...
        <p>
          ...
          may modify your browser settings to reject cookies, though some
          features of the Website may not function properly as a result.
        </p>

        <h2 className="text-2xl font-bold mt-6 mb-2">7. Third-Party Links</h2>
        <p>
          Our Website may contain links to third-party websites that are not
          operated by us. We have no control over the content or privacy
          practices of these external websites, and we encourage you to review
